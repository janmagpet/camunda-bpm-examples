...
public class CustomHistoryLevelProcessEnginePlugin extends AbstractProcessEnginePlugin {
  ...
  protected PerProcessHistoryLevel perProcessHistoryLevel = new PerProcessHistoryLevel();
  ...
  public void preInit(ProcessEngineConfigurationImpl processEngineConfiguration) {
    ...
    customHistoryLevels.add(new CustomVariableHistoryLevel());
    customHistoryLevels.add(perProcessHistoryLevel);
  }

  public void postInit(ProcessEngineConfigurationImpl processEngineConfiguration) {
    perProcessHistoryLevel.addHistoryLevels(processEngineConfiguration.getCustomHistoryLevels());
  }
